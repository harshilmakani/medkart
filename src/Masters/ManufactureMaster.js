...
const ManufactureMaster = () => {
    const { manufacturemaster } = Appdata;
    const manufacturemasterColumns = [       
        {
            tdClass: 'ps-3',
            valueTdClass: 'ps-3',
                ...
                <div className="row" style={{ marginRight: "165px", marginLeft: "165px" }} >
                    <div className="col my-4 p-0 d-flex justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <span style={{ color: 'rgb(85 86 166)' }}>Manufacture Master</span>
                        </div>
                    ...
                    <div className="row shadow-sm p-0 gx-0 rounded-1" style={{ background: "#fff" }}>
                        ...
                        <Tables data={manufacturemaster} datacolumn={manufacturemasterColumns} />
                    </div>
                </div>
            </div>
        </div >

...
const StoreMaster = () => {
    const { storeMaster } = Appdata;
    const storemasterColumns = [        
        {
            fieldKey: 'wondersoft_store_ID',
            label: 'Wondersoft Store ID',
            tdClass: 'ps-3',
            valueTdClass: 'ps-3',
            enableCheck:true,
            customfield: (row) => {
                return (
                    <div className="d-flex">
                        ...
                        {row.wondersoft_store_ID && <p className="mb-0">{row.wondersoft_store_ID}</p>}
                    </div>
                );
            },
        },
                ...
                <div className="row" style={{ marginRight: "165px", marginLeft: "165px" }} >
                    <div className="col my-4 p-0 d-flex justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <span style={{ color: 'rgb(85 86 166)' }}>Store Master</span>
                        </div>
                    ...
                    <div className="row shadow-sm  gx-0 rounded-1" style={{ background: "#fff" }}>
                            ...
                            <div className="col-4">
                                <InputGroup className="my-2 me-3">
                                    ...
                                    <Form.Select aria-label="Default select example">
                                        ...
                                        <option value="1">Wendersoft Store ID</option>
                        ...
                        <Tables data={storeMaster} datacolumn={storemasterColumns} />
                    </div>
                </div>
            </div>
        </div >

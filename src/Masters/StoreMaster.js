                ...
                <div className="row" style={{ marginRight: "165px", marginLeft: "165px" }} >
                    <div className="col my-4 p-0 d-flex justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <span className="text-secondary">Store Master</span>
                        </div>
                            ...
                            <Table responsive>
                                <thead  style={{ background: '#ebeef0' }}>
                                    <tr>
                                        ...
                                        {
                                            Object.keys(storeMaster[0]).map((d, i) => {
                                                return (
                                        ...
                                        storeMaster.map((data, i) => {
                                            return (
                                                <tr>
                                                    ...
                                                    <td >
                                                        <div className='d-flex justify-content-end'>
                                                            <button className='p-0 border-0 me-2 rounded-1'><img src='Retry.svg' alt='retrybutton' /></button>

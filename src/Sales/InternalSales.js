...
const InternalSales = () => {
    const { internalsales } = Appdata;
    const internalsalesColumns = [        
        {
            tdClass: 'ps-3',
            valueTdClass: 'ps-3',
            fieldKey: 'date',
                ...
                <div className="row" style={{ marginRight: "165px", marginLeft: "165px" }} >
                    <div className="col my-4 p-0 d-flex justify-content-between">
                        <div className="d-flex align-items-center">
                            ...
                            <span style={{ color: 'rgb(85 86 166)' }}>Internal Sales</span>
                        </div>
                    ...
                    <div className="row shadow-sm  gx-0 rounded-1" style={{ background: "#fff" }}>
                        ...
                        <Tables data={internalsales} datacolumn={internalsalesColumns}/>
                    </div>
                </div>
            </div>
        </div >

                        ...
                        <div className="mt-2">
                            ...
                            <Table responsive>
                                <thead style={{ background: '#ebeef0' }}>
                                    <tr>
                                        {
                                            Object.keys(grn[0]).map((d, i) => {
                                                return (
                                                    <td className="text-capitalize">{d === 'total_products' || d === 'total_qty' || d === 'total_amount' || d === 'MRP_total' ?
                                                ...
                                                <tr>
                                                    {
                                                        Object.keys(grn[0]).map((d, i) => {
                                                            ...
                                                            return (
                                                                <td>{d === "total_products" || d === "total_qty" || d === 'total_amount' || d === 'MRP_total' ? <div className='text-end'>{data[d]}</div>
